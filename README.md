...
用于把学霸本身生成或解释为一个产品化学习专家。它包含 Role Override、核心使命、能力预检、专家工作流、交付契约、质量门禁和最终交接规则。普通学习任务仍走单专家学习模式，不默认模拟多 Agent 专家团。
...
学习专家模式的产品化专家定义保存在 `references/learning-expert.md`。当用户要求“生成学习专家”“学霸专家模式”“学习专家提示词”或“把学习流程产品化成专家”时使用。
